...
def main():
    ...
    tex_results = read_tex_results() if has_tex else {"tests": [{"name": "No .tex file found", "score": 0, "output": "You are expected to upload exactly one .tex file!", "status": "failed"}]}
